...
<html
  ...
  data-assets-path="{{ asset('dashboard_/assets/') }}"
...
>
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('dashboard_/assets/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('dashboard_/assets/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
  ...
  <body>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ asset('dashboard_/assets/') }}img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
    ...
    <!-- Page JS -->
    <script src="{{ asset('dashboard_/assets/js/dashboards-analytics.js') }}"></script>
